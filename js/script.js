  ...
  let coolhehi = [
    ...
    'У якім стылі пераважна ўжываюцца намінатыўныя<br> сказы?',
    ...
    'ВЫПІШЫЦЕ ФОРМАЎТВАРАЛЬНЫЯ ЧАСЦІЦЫ:<br> хоць, амаль, бы, толькі',
  ...
  let hehianwers = [
    ...
    ["у мастацкім", "мастацкім", "мастацкім стылі", "у мастацкім стылі", "мастацкі", "мастацкі стыль"],
    ["мне сілы", "сілы мне"],
    ["прымыканне"],
    ["бы"],
    ["прыгажун"],
